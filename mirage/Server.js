...
class Server {
  ...
  /**
   * Set the delay for the server. This will be applied to all routes defined while the delay is set
   * @param {Number} delay The delay in ms for the request. Defaults to 0
   */
  setDelay(delay) {
    this.delay = delay;
  }
