...
/**
 * Deserializes a JSON API relationships request into an array of ids
 * @param  {Object} data The JSON API relationship object
 * @return {Array}       An array of relationship ids
 *
 * @example
 * input:
 * {
 ...
 * [1,2]
 */
export function deserializeJsonApiRelations(data) {
  const dataObj = data.data;
  if(Array.isArray(dataObj)) {
    return dataObj.map((relObj) => parseInt(relObj.id));
  } else {
